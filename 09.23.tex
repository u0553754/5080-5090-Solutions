{ \bf 09.23 }
Let $X_{1},...,X_{n}$ be a random Sample from a normal distribution, $X_{i}~N(0,\theta)$.\\
...
$E[x-{i}^2]$ looks complicated so instead of calculating directly use $var=E{x^2]-E[x]^2$\\
